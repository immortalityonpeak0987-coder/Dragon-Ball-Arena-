...
CHARACTER_ATTACKS = {
    "Goku": ["Kamehameha", "Spirit Bomb", "Dragon Fist", "Instant Transmission Kamehameha"],
    "Vegeta": ["Galick Gun", "Final Flash", "Big Bang Attack", "Final Explosion"],
    "Broly": ["Eraser Cannon", "Gigantic Meteor", "Blaster Shell", "Omega Blaster"],
    "Gohan": ["Kamehameha", "Masenko", "Father-Son Kamehameha", "Ultimate Kamehameha"],
    "Piccolo": ["Special Beam Cannon", "Hellzone Grenade", "Light Grenade", "Orange Kamehameha"],
    "Frieza": ["Death Beam", "Death Ball", "Supernova", "Golden Death Beam"],
    "Cell": ["Kamehameha", "Special Beam Cannon", "Solar Flare", "Perfect Kamehameha"],
    "Buu": ["Vanishing Ball", "Assault Rain", "Chocolate Beam", "Planet Burst"],
    "Beerus": ["Sphere of Destruction", "Cataclysmic Orb", "Hakai", "Beerus Ball"],
    "Whis": ["Kiai", "Staff Attack", "Temporal Rewind", "Angel Beam"],
    "Jiren": ["Power Impact", "Glare", "Overheat Magnetron", "Ultimate Impact"],
    "Hit": ["Time Skip", "Flash Fist Crush", "Vital Point Attack", "Cage of Time"],
    "Gogeta": ["Big Bang Kamehameha", "Stardust Breaker", "Soul Punisher", "Meteor Explosion"],
    "Vegito": ["Final Kamehameha", "Spirit Sword", "Savage Strike", "Big Bang Attack"],
    "Trunks": ["Burning Attack", "Finish Buster", "Sword Attack", "Final Hope Slash"],
    "Goten": ["Kamehameha", "Assault", "Super Goten Strike", "Kikoha"],
    "Gotenks": ["Galactic Donut", "Super Ghost Kamikaze", "Charging Ultra Buu Buu", "Victory Cannon"],
    "Krillin": ["Destructo Disc", "Kamehameha", "Solar Flare", "Scatter Kamehameha"],
    "Tien": ["Tri-Beam", "Solar Flare", "Multi-Form", "Neo Tri-Beam"],
    "Yamcha": ["Spirit Ball", "Wolf Fang Fist", "Kamehameha", "Neo Wolf Fang Fist"],
    "Android": ["Energy Wave", "Photon Strike", "Barrier", "Hell Flash"],
    "Cooler": ["Death Beam", "Supernova Cooler", "Death Flash", "Golden Supernova"],
    "Janemba": ["Bunkai Teleport", "Dimension Sword", "Lightning Shower Rain", "Rakshasa Claw"],
    "Bojack": ["Galactic Buster", "Grand Smasher", "Galactic Tyrant", "Full Power Energy Wave"],
    "Zamasu": ["Holy Wrath", "Divine Wrath", "Lightning of Absolution", "Blades of Judgment"],
    "Black": ["Black Kamehameha", "Black Power Ball", "Divine Lasso", "Fierce God Slicer"],
    "Toppo": ["Justice Flash", "Justice Tornado", "Hakai", "God of Destruction's Wrath"],
    "Kefla": ["Gigantic Burst", "Gigantic Breaker", "Ray Blast", "Gigantic Ray"],
    "Caulifla": ["Crush Cannon", "Energy Wave", "Full Power Energy Wave", "Super Saiyan Rage"],
    "Kale": ["Blaster Meteor", "Eraser Cannon", "Gigantic Omega", "Ray Blast"],
    "Cabba": ["Galick Cannon", "Continuous Energy Bullet", "Galick Gun", "Final Flash"],
    "Moro": ["Energy Drain", "Planet Destruction", "Copy Ability", "Earth Absorption"],
    "Granolah": ["Sniper Shot", "Hakai Sphere", "Clone Attack", "Full Power Blast"],
    "Gas": ["Weapon Creation", "Telekinesis", "Power Strike", "Instinct Power"],
    "Omega": ["Minus Energy Ball", "Dragon Thunder", "Whirlwind Spin", "Gigantic Blaze"],
    "Baby": ["Revenge Death Ball", "Super Galick Gun", "Revenge Blast", "Final Flash"],
    "Super 17": ["Flash Bomber", "Hell Storm", "Energy Absorption", "Shocking Death Ball"],
    "default": ["Energy Wave", "Ki Blast", "Power Strike", "Full Power Attack"]
}
...
DRAGON_BALL_CHARACTERS = [
    ...
    {"name": "Goku (Super Saiyan God)", "power": 1800, "rarity": "epic"},
    {"name": "Goku (Super Saiyan Blue)", "power": 2500, "rarity": "legendary"},
    ...
    {"name": "Vegeta (Super Saiyan Blue)", "power": 2400, "rarity": "legendary"},
    ...
    {"name": "Gohan (Kid)", "power": 50, "rarity": "common"},
    {"name": "Gohan (Teen)", "power": 200, "rarity": "common"},
    {"name": "Gohan (Super Saiyan 2 Teen)", "power": 700, "rarity": "rare"},
    {"name": "Gohan (Ultimate)", "power": 2000, "rarity": "epic"},
    {"name": "Gohan (Beast)", "power": 6500, "rarity": "mythic"},
    {"name": "Piccolo", "power": 200, "rarity": "common"},
    {"name": "Piccolo (Fused with Kami)", "power": 600, "rarity": "rare"},
    {"name": "Piccolo (Orange)", "power": 4500, "rarity": "legendary"},
    {"name": "Frieza (First Form)", "power": 150, "rarity": "common"},
    {"name": "Frieza (Final Form)", "power": 500, "rarity": "rare"},
    {"name": "Frieza (Golden)", "power": 3200, "rarity": "legendary"},
    {"name": "Frieza (Black)", "power": 7000, "rarity": "mythic"},
    {"name": "Cell (Imperfect)", "power": 250, "rarity": "common"},
    {"name": "Cell (Perfect)", "power": 600, "rarity": "rare"},
    {"name": "Cell (Super Perfect)", "power": 750, "rarity": "epic"},
    {"name": "Cell Max", "power": 5500, "rarity": "mythic"},
    {"name": "Majin Buu (Fat)", "power": 700, "rarity": "rare"},
    {"name": "Super Buu", "power": 850, "rarity": "epic"},
    {"name": "Kid Buu", "power": 900, "rarity": "epic"},
    {"name": "Beerus", "power": 8000, "rarity": "mythic"},
    {"name": "Whis", "power": 10000, "rarity": "mythic"},
    {"name": "Jiren", "power": 5500, "rarity": "mythic"},
    {"name": "Jiren (Full Power)", "power": 7500, "rarity": "mythic"},
    {"name": "Hit", "power": 2000, "rarity": "legendary"},
    {"name": "Trunks (Future)", "power": 300, "rarity": "rare"},
    {"name": "Trunks (Super Saiyan Rage)", "power": 2200, "rarity": "legendary"},
    {"name": "Goten", "power": 150, "rarity": "common"},
    {"name": "Gotenks (Super Saiyan 3)", "power": 800, "rarity": "epic"},
    {"name": "Vegito (Super Saiyan Blue)", "power": 9000, "rarity": "mythic"},
    {"name": "Gogeta (Super Saiyan 4)", "power": 8500, "rarity": "mythic"},
    {"name": "Gogeta (Super Saiyan Blue)", "power": 9500, "rarity": "mythic"},
    {"name": "Krillin", "power": 75, "rarity": "common"},
    {"name": "Tien", "power": 80, "rarity": "common"},
    {"name": "Yamcha", "power": 50, "rarity": "common"},
    {"name": "Android 17", "power": 400, "rarity": "rare"},
    {"name": "Android 17 (DBS)", "power": 2500, "rarity": "legendary"},
    {"name": "Android 18", "power": 380, "rarity": "rare"},
    {"name": "Cooler (Final Form)", "power": 550, "rarity": "rare"},
    {"name": "Cooler (Metal)", "power": 1000, "rarity": "epic"},
    {"name": "Janemba", "power": 900, "rarity": "epic"},
    {"name": "Super Janemba", "power": 1300, "rarity": "epic"},
    {"name": "Bojack", "power": 500, "rarity": "rare"},
    {"name": "Tapion", "power": 350, "rarity": "rare"},
    {"name": "Bardock", "power": 90, "rarity": "common"},
    {"name": "Zamasu (Fused)", "power": 4000, "rarity": "legendary"},
    {"name": "Goku Black (Super Saiyan Rose)", "power": 2800, "rarity": "legendary"},
    {"name": "Toppo (God of Destruction)", "power": 4500, "rarity": "legendary"},
    {"name": "Kefla", "power": 2200, "rarity": "legendary"},
    {"name": "Kefla (Super Saiyan 2)", "power": 3500, "rarity": "legendary"},
    {"name": "Caulifla", "power": 600, "rarity": "rare"},
    {"name": "Kale", "power": 500, "rarity": "rare"},
    {"name": "Kale (Berserker)", "power": 2500, "rarity": "legendary"},
    {"name": "Cabba", "power": 700, "rarity": "rare"},
    {"name": "Master Roshi", "power": 80, "rarity": "common"},
    {"name": "Mr. Satan", "power": 10, "rarity": "common"},
    {"name": "Pan", "power": 150, "rarity": "common"},
    {"name": "Omega Shenron", "power": 4000, "rarity": "legendary"},
    {"name": "Baby Vegeta", "power": 1500, "rarity": "epic"},
    {"name": "Super Baby 2", "power": 2500, "rarity": "legendary"},
    {"name": "Super 17", "power": 2800, "rarity": "legendary"},
    {"name": "Granolah", "power": 5000, "rarity": "legendary"},
    {"name": "Gas", "power": 5500, "rarity": "mythic"},
    {"name": "Moro", "power": 4500, "rarity": "legendary"},
    {"name": "Gamma 1", "power": 3000, "rarity": "legendary"},
    {"name": "Gamma 2", "power": 3000, "rarity": "legendary"},
    {"name": "Goku (Mini - Daima)", "power": 120, "rarity": "rare"},
    {"name": "Vegeta (Mini - Daima)", "power": 115, "rarity": "rare"},
    {"name": "Glorio (Daima)", "power": 200, "rarity": "rare"},
    {"name": "Gomah (Daima)", "power": 50, "rarity": "common"},
    {"name": "Tamagami (Daima)", "power": 1500, "rarity": "epic"},
    {"name": "Turles", "power": 85, "rarity": "common"},
    {"name": "Lord Slug", "power": 400, "rarity": "rare"},
    {"name": "Android 13", "power": 450, "rarity": "rare"},
    {"name": "Super Android 13", "power": 700, "rarity": "epic"},
    {"name": "Cumber", "power": 4000, "rarity": "legendary"},
    {"name": "Hearts", "power": 3500, "rarity": "legendary"},
    {"name": "Fu", "power": 2500, "rarity": "legendary"},
    {"name": "Mechikabura", "power": 8000, "rarity": "mythic"},
    {"name": "Xeno Goku", "power": 7000, "rarity": "mythic"},
    {"name": "Xeno Vegeta", "power": 6800, "rarity": "mythic"},
]
...
MAFUBA_TYPES = {
    "ultra_pro": {"name": "Mafuba Ultra Pro", "catch_rate": 0.95, "price": 500},
    "pro": {"name": "Mafuba Pro", "catch_rate": 0.75, "price": 300},
    "power": {"name": "Mafuba Power", "catch_rate": 0.50, "price": 150},
    "base": {"name": "Mafuba Base", "catch_rate": 0.30, "price": 50},
}
...
def is_owner(user_id):
    conn = get_db_connection()
    cur = conn.cursor()
    cur.execute("SELECT * FROM admins WHERE user_id = %s AND is_owner = TRUE", (user_id, ))
    result = cur.fetchone()
    cur.close()
    conn.close()
...
def is_approved_group(group_id):
    conn = get_db_connection()
    cur = conn.cursor()
    cur.execute("SELECT * FROM approved_groups WHERE group_id = %s", (group_id, ))
    result = cur.fetchone()
    cur.close()
    conn.close()
    return result is not None
...
async def register(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if existing:
            await update.message.reply_text("⚠️ You're already registered! Use /stats to see your profile.")
            return

        keyboard = [
            [InlineKeyboardButton("🔥 Goku (Power: 100)", callback_data="starter_goku")],
            [InlineKeyboardButton("👑 Vegeta (Power: 95)", callback_data="starter_vegeta")],
            [InlineKeyboardButton("💪 Broly (Power: 150)", callback_data="starter_broly")]
        ]
...
async def starter_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if choice not in starter_map:
            await query.edit_message_text("⚠️ Invalid selection. Please use /register again.")
            return
        ...
        cur.execute(
            ...
            (user_id, starter['name'], starter['power'], starter['power'], starter['rarity'])
        )
        char_id = cur.fetchone()['id']

        cur.execute("INSERT INTO teams (user_id, team_number, character_id, slot) VALUES (%s, 1, %s, 1)", (user_id, char_id))
        conn.commit()
...
May your power level rise beyond limits! 💪
        ...
        try:
            ...
            await context.bot.send_animation(chat_id=query.message.chat_id, animation=WELCOME_GIF, caption=welcome_message, parse_mode='Markdown')
        ...
        conn.rollback()
        await query.edit_message_text("An error occurred during registration. Please use /register again.")
    finally:
        cur.close()
        conn.close()
...
async def catch_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if player.get('in_tournament'):
            high_power_chars = [c for c in DRAGON_BALL_CHARACTERS if c['power'] >= 1000]
        ...
        cur.execute(
            ...
            (user_id, character['name'], character['power'], character['rarity'])
        )
        conn.commit()
        if player.get('in_tournament'):
            keyboard = [
                [InlineKeyboardButton("🏆 Tournament Mafuba (30%)", callback_data="mafuba_tournament")], 
                [InlineKeyboardButton("❌ Run Away", callback_data="mafuba_run")]
            ]
        else:
            keyboard = [
                [InlineKeyboardButton("🏺 Mafuba Base (30%)", callback_data="mafuba_base")],
                [InlineKeyboardButton("⚡ Mafuba Power (50%)", callback_data="mafuba_power")],
                [InlineKeyboardButton("🔥 Mafuba Pro (75%)", callback_data="mafuba_pro")],
                [InlineKeyboardButton("💎 Mafuba Ultra Pro (95%)", callback_data="mafuba_ultra_pro")],
                [InlineKeyboardButton("❌ Run Away", callback_data="mafuba_run")]
            ]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
async def mafuba_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        cur.execute("SELECT * FROM players WHERE user_id = %s", (user_id, ))
        player = cur.fetchone()
        cur.execute("SELECT * FROM wild_spawns WHERE user_id = %s", (user_id, ))
        wild = cur.fetchone()
        if not wild:
            await query.edit_message_text("⚠️ No wild character here! Use /catch to find one.")
            return
        if mafuba_type == "run":
            cur.execute("DELETE FROM wild_spawns WHERE user_id = %s", (user_id, ))
            conn.commit()
            await query.edit_message_text("🏃 You ran away! Use /catch to find another character.")
            return
        
        if mafuba_type == "tournament":
            if player.get('tournament_mafuba', 0) <= 0:
                await query.edit_message_text("⚠️ No Tournament Mafuba left! Tournament ended.")
                cur.execute("UPDATE players SET in_tournament = FALSE WHERE user_id = %s", (user_id, ))
                conn.commit()
                return
            catch_rate = TOURNAMENT_CATCH_RATE
            cur.execute("UPDATE players SET tournament_mafuba = tournament_mafuba - 1 WHERE user_id = %s", (user_id, ))
        else:
            mafuba_col = f"mafuba_{mafuba_type}"
            if player.get(mafuba_col, 0) <= 0:
                await query.edit_message_text(f"⚠️ No {MAFUBA_TYPES[mafuba_type]['name']} left! Buy more at /shop")
                return
            catch_rate = MAFUBA_TYPES[mafuba_type]['catch_rate']
            cur.execute(f"UPDATE players SET {mafuba_col} = {mafuba_col} - 1 WHERE user_id = %s", (user_id, ))
        ...
        if success:
            cur.execute(
                "INSERT INTO player_characters (user_id, name, power, current_power, rarity) VALUES (%s, %s, %s, %s, %s)",
                (user_id, wild['name'], wild['power'], wild['power'], wild.get('rarity', 'common'))
            )
            ...
            cur.execute("UPDATE players SET xp = %s, level = %s WHERE user_id = %s", (new_xp, new_level, user_id))
            cur.execute("DELETE FROM wild_spawns WHERE user_id = %s", (user_id, ))
            conn.commit()
            await query.edit_message_text(f"✅ **CAUGHT!** ✅\n\n🐉 **{wild['name']}** joined your team!\n💪 Power: {wild['power']}\n✨ +{xp_gain} XP!{level_msg}\n\nUse /catch to find more!", parse_mode='Markdown')
        else:
            cur.execute("DELETE FROM wild_spawns WHERE user_id = %s", (user_id, ))
            conn.commit()
            await query.edit_message_text(f"❌ **ESCAPED!** ❌\n\n{wild['name']} broke free from the Mafuba!\n\nUse /catch to try again!", parse_mode='Markdown')
        
        cur.execute("SELECT * FROM players WHERE user_id = %s", (user_id, ))
        player = cur.fetchone()
        if player.get('in_tournament') and player.get('tournament_mafuba', 0) <= 0:
            cur.execute("UPDATE players SET in_tournament = FALSE, tournament_mafuba = 0 WHERE user_id = %s", (user_id, ))
            conn.commit()
            await query.message.reply_text("🏆 Tournament of Power ended! You're back to normal mode.")
    except Exception as e:
        logging.error(f"Mafuba callback error: {e}")
        await query.edit_message_text("An error occurred. Please try /catch again.")
    finally:
        cur.close()
        conn.close()
...
async def shop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("⚡ Power - 150 coins", callback_data="buy_power")],
            [InlineKeyboardButton("🔥 Pro - 300 coins", callback_data="buy_pro")],
            [InlineKeyboardButton("💎 Ultra Pro - 500 coins", callback_data="buy_ultra_pro")],
...
async def buy_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if player.get('coins', 0) < price:
            await query.edit_message_text(f"⚠️ Not enough coins! You have {player.get('coins', 0)}, need {price}.")
            return
        mafuba_col = f"mafuba_{mafuba_type}"
        cur.execute(f"UPDATE players SET coins = coins - %s, {mafuba_col} = {mafuba_col} + 1 WHERE user_id = %s", (price, user_id))
        conn.commit()
        await query.edit_message_text(f"✅ Bought {MAFUBA_TYPES[mafuba_type]['name']} for {price} coins!")
    finally:
        cur.close()
        conn.close()
...
async def team(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if not player:
            await update.message.reply_text("⚠️ You need to /register first!")
            return
        cur.execute("SELECT * FROM player_characters WHERE user_id = %s ORDER BY power DESC", (user_id, ))
        characters = cur.fetchall()
        
        keyboard = [[InlineKeyboardButton(f"📋 Team {i}", callback_data=f"viewteam_{i}")] for i in range(1, 7)]
        keyboard.extend([
            [InlineKeyboardButton("🛠️ Build Team", callback_data="buildteam_select")],
            [InlineKeyboardButton("📋 All Characters", callback_data="viewteam_all")],
            [InlineKeyboardButton("❌ Close", callback_data="close_shop")]
        ])
...
async def team_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if action == "all":
            cur.execute("SELECT * FROM player_characters WHERE user_id = %s ORDER BY power DESC LIMIT 20", (user_id, ))
            chars = cur.fetchall()
            if not chars:
                await query.edit_message_text("No characters yet! Use /catch to find some.")
            else:
                char_list = "\n".join([f"{RARITY_EMOJIS.get(c.get('rarity', 'common'), '⚪')} {c['name']} - Power: {c['power']}" for c in chars])
                await query.edit_message_text(f"📋 **All Characters (Top 20):**\n\n{char_list}", parse_mode='Markdown')
        else:
            team_num = int(action)
            cur.execute(
                """
            ...
            keyboard = [
                [InlineKeyboardButton("🔄 Set as Active", callback_data=f"setactive_{team_num}")],
                [InlineKeyboardButton("🔙 Back", callback_data="back_teams")]
            ]
            reply_markup = InlineKeyboardMarkup(keyboard)
            
            if not team_chars:
                await query.edit_message_text(f"**Team {team_num}** is empty!\n\nUse 'Build Team' to add characters.", reply_markup=reply_markup, parse_mode='Markdown')
            else:
                char_list = "\n".join([f"Slot {c['slot']}: 🐉 {c['name']} - Power: {c['power']}" for c in team_chars])
                await query.edit_message_text(f"**Team {team_num}:**\n\n{char_list}", reply_markup=reply_markup, parse_mode='Markdown')
    finally:
        cur.close()
        conn.close()

async def buildteam_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    user_id = query.from_user.id
    if query.data == "buildteam_select":
        keyboard = [[InlineKeyboardButton(f"Team {i}", callback_data=f"buildteam_{i}")] for i in range(1, 7)]
        keyboard.append([InlineKeyboardButton("🔙 Back", callback_data="back_teams")])
        await query.edit_message_text("Select a team to build:", reply_markup=InlineKeyboardMarkup(keyboard))
        return
    ...
    cur = conn.cursor()
    try:
        cur.execute("DELETE FROM teams WHERE user_id = %s AND team_number = %s", (user_id, team_num))
        conn.commit()
        cur.execute("SELECT * FROM player_characters WHERE user_id = %s ORDER BY power DESC LIMIT 20", (user_id, ))
        chars = cur.fetchall()
        if not chars:
            await query.edit_message_text("No characters available! Use /catch first.")
            return
            
        keyboard = [[InlineKeyboardButton(f"{c['name']} ({c['power']})", callback_data=f"selectchar_{c['id']}")] for c in chars]
        keyboard.extend([
            [InlineKeyboardButton("✅ Done", callback_data="buildteam_done")],
            [InlineKeyboardButton("❌ Cancel", callback_data="back_teams")]
        ])
        await query.edit_message_text(f"🛠️ **Building Team {team_num}**\n\nSelect up to 4 characters:\n(Selected: 0/4)", reply_markup=InlineKeyboardMarkup(keyboard), parse_mode='Markdown')
    finally:
        cur.close()
        conn.close()

async def selectchar_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    user_id = query.from_user.id
    ...
    try:
        cur.execute("SELECT * FROM player_characters WHERE user_id = %s ORDER BY power DESC LIMIT 20", (user_id, ))
        chars = cur.fetchall()
        keyboard = [[InlineKeyboardButton(f"{'✅ ' if c['id'] in selected else ''}{c['name']} ({c['power']})", callback_data=f"selectchar_{c['id']}")] for c in chars]
        keyboard.extend([
            [InlineKeyboardButton("✅ Done", callback_data="buildteam_done")],
            [InlineKeyboardButton("❌ Cancel", callback_data="back_teams")]
        ])
        await query.edit_message_text(f"🛠️ **Building Team {team_num}**\n\nSelect up to 4 characters:\n(Selected: {len(selected)}/4)", reply_markup=InlineKeyboardMarkup(keyboard), parse_mode='Markdown')
    finally:
        cur.close()
        conn.close()

async def buildteam_done_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    user_id = query.from_user.id
    selected = context.user_data.get('selected_chars', [])
    ...
    try:
        ...
        for slot, char_id in enumerate(selected, 1):
            cur.execute("INSERT INTO teams (user_id, team_number, character_id, slot) VALUES (%s, %s, %s, %s)", (user_id, team_num, char_id, slot))
        conn.commit()
        context.user_data['selected_chars'] = []
        context.user_data['building_team'] = None
        await query.edit_message_text(f"✅ Team {team_num} built with {len(selected)} characters!")
    finally:
        cur.close()
        conn.close()

async def setactive_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    user_id = query.from_user.id
    ...
    cur = conn.cursor()
    try:
        cur.execute("UPDATE players SET active_team = %s WHERE user_id = %s", (team_num, user_id))
        conn.commit()
        await query.edit_message_text(f"✅ Team {team_num} is now your active team!")
    finally:
        cur.close()
        conn.close()

async def back_teams_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    user_id = query.from_user.id
    conn = get_db_connection()
    ...
    try:
        cur.execute("SELECT * FROM players WHERE user_id = %s", (user_id, ))
        player = cur.fetchone()
        cur.execute("SELECT COUNT(*) as count FROM player_characters WHERE user_id = %s", (user_id, ))
...
async def fight(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_type != "private":
        await update.message.reply_text("⚠️ Fighting is only available in private chat with the bot!")
        return
    ...
    try:
        ...
        team_chars = cur.fetchall()
        if not team_chars:
            await update.message.reply_text(f"⚠️ Team {player.get('active_team', 1)} is empty! Use /team to add characters.")
            return
        ...
        keyboard = [
            ...
            [InlineKeyboardButton(f"⚔️ {attacks[1]}", callback_data="fight_attack_1")],
            [InlineKeyboardButton(f"⚔️ {attacks[2]}", callback_data="fight_attack_2")],
            [InlineKeyboardButton(f"⚔️ {attacks[3]}", callback_data="fight_attack_3")],
            [InlineKeyboardButton("🔄 Swap Character", callback_data="fight_swap")],
            [InlineKeyboardButton("🏃 Run Away", callback_data="fight_run")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        
        caption = f"⚔️ **BATTLE BEGINS!** ⚔️\n\n🔵 **YOUR FIGHTER:**\n{your_fighter['name']}\n💪 Power: {your_fighter.get('current_power', your_fighter['power'])}/{your_fighter['power']}\n\n🔴 **ENEMY:**\n{enemy['name']}\n💪 Power: {enemy['power']}\n\nChoose your attack!"
        
        try:
            await update.message.reply_animation(animation=FIGHT_GIF, caption=caption, reply_markup=reply_markup, parse_mode='Markdown')
        except Exception as e:
...
async def fight_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        cur.execute("SELECT * FROM players WHERE user_id = %s", (user_id, ))
        player = cur.fetchone()
        cur.execute("SELECT * FROM battle_sessions WHERE user_id = %s", (user_id, ))
        battle = cur.fetchone()
        
        if not battle:
            await query.edit_message_text("⚠️ No active battle! Use /fight to start one.")
            return
        ...
        if action == "swap":
            ...
            if not available:
                await query.answer("No other characters available!", show_alert=True)
                return
            if battle.get('last_swap_time'):
                elapsed = (datetime.now() - battle['last_swap_time']).total_seconds()
                if elapsed < 5:
                    await query.answer(f"Swap cooldown! Wait {int(5 - elapsed)}s", show_alert=True)
                    return
            
            keyboard = [[InlineKeyboardButton(f"{c['name']} ({c['current_power']} HP)", callback_data=f"swap_{c['slot']}")] for c in available]
            keyboard.append([InlineKeyboardButton("🔙 Back", callback_data="fight_back")])
            await query.edit_message_text("🔄 Select a character to swap:", reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        if action.startswith("attack_"):
            ...
            if random.random() < 0.15:
                enemy_damage = random.randint(battle['enemy_current_power'] // 5, battle['enemy_current_power'] // 3)
                new_your_power = max(0, current_fighter['current_power'] - enemy_damage)
                cur.execute("UPDATE player_characters SET current_power = %s WHERE id = %s", (new_your_power, current_fighter['id']))
                conn.commit()
                ...
                await query.edit_message_text(
                    f"💨 **INSTANT TRANSMISSION!** 💨\n\n{battle['enemy_name']} dodged your {attack_name}!\nEnemy countered for {enemy_damage} damage!\n\n🔵 {current_fighter['name']} - {new_your_power} HP\n🔴 {battle['enemy_name']} - {battle['enemy_current_power']} HP",
                    reply_markup=InlineKeyboardMarkup(keyboard),
                    parse_mode='Markdown'
                )
                return

            your_damage = random.randint(current_fighter['current_power'] // 4, current_fighter['current_power'] // 2)
            enemy_damage = random.randint(battle['enemy_current_power'] // 6, battle['enemy_current_power'] // 4)
            
            new_enemy_power = max(0, battle['enemy_current_power'] - your_damage)
            new_your_power = max(0, current_fighter['current_power'] - enemy_damage)
            
            cur.execute("UPDATE battle_sessions SET enemy_current_power = %s WHERE user_id = %s", (new_enemy_power, user_id))
            cur.execute("UPDATE player_characters SET current_power = %s WHERE id = %s", (new_your_power, current_fighter['id']))
            conn.commit()
            ...
            if new_enemy_power <= 0:
                ...
                if next_fighter:
                    cur.execute("UPDATE battle_sessions SET active_char_slot = %s WHERE user_id = %s", (next_fighter['slot'], user_id))
                    conn.commit()
...
async def swap_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cur = conn.cursor()
    try:
        cur.execute("UPDATE battle_sessions SET active_char_slot = %s, last_swap_time = NOW() WHERE user_id = %s", (slot, user_id))
        conn.commit()
        cur.execute("SELECT * FROM battle_sessions WHERE user_id = %s", (user_id, ))
        battle = cur.fetchone()
        cur.execute("SELECT * FROM players WHERE user_id = %s", (user_id, ))
        ...
        cur.execute(
            """
            SELECT * FROM teams t JOIN player_characters pc ON t.character_id = pc.id 
            WHERE t.user_id = %s AND t.team_number = %s AND t.slot = %s
...
async def tournament(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    chat_type = update.effective_chat.type
    if chat_type != "private":
        await update.message.reply_text("⚠️ Tournament of Power is only available in private chat!")
        return
    conn = get_db_connection()
    cur = conn.cursor()
    try:
        ...
        if not player:
            ...
            return
        if player.get('in_tournament'):
            await update.message.reply_text(f"🏆 **TOURNAMENT OF POWER** 🏆\n\nYou're in the tournament!\n🏺 Tournament Mafuba: {player.get('tournament_mafuba', 0)}\n\nUse /catch to find powerful characters!", parse_mode='Markdown')
            return
        keyboard = [
            [InlineKeyboardButton(f"🏆 Enter ({TOURNAMENT_ENTRY_FEE} coins)", callback_data="enter_tournament")], 
            [InlineKeyboardButton("❌ Cancel", callback_data="close_shop")]
        ]
        await update.message.reply_text(f"🏆 **TOURNAMENT OF POWER** 🏆\n\nEntry Fee: {TOURNAMENT_ENTRY_FEE} coins\nYour Coins: {player.get('coins', 0)}\n\n**Rewards:**\n🏺 15 Tournament Mafuba\n⚡ High-level characters spawn!\n🎯 30% catch rate\n\nReady to enter?", reply_markup=InlineKeyboardMarkup(keyboard), parse_mode='Markdown')
    finally:
        cur.close()
        conn.close()
...
async def tournament_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if player.get('coins', 0) < TOURNAMENT_ENTRY_FEE:
            await query.edit_message_text(f"⚠️ Not enough coins! Need {TOURNAMENT_ENTRY_FEE}, have {player.get('coins', 0)}.")
            return
        cur.execute(
            """
            UPDATE players SET coins = coins - %s, in_tournament = TRUE, tournament_mafuba = %s WHERE user_id = %s
            """, (TOURNAMENT_ENTRY_FEE, TOURNAMENT_MAFUBA_COUNT, user_id)
        )
        conn.commit()
        await query.edit_message_text(f"🏆 **WELCOME TO TOURNAMENT OF POWER!** 🏆\n\nYou received 15 Tournament Mafuba!\n\nUse /catch to find powerful characters!\nGood luck, warrior!", parse_mode='Markdown')
    finally:
        cur.close()
        conn.close()
async def duel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not update.message.reply_to_message:
        await update.message.reply_text("⚠️ Reply to a user's message with /duel to challenge them!")
        return
    ...
    try:
        ...
        if not challenger:
            ...
            return
        if not defender:
            await update.message.reply_text("⚠️ The other player needs to register first!")
            return
        ...
        keyboard = [
            [InlineKeyboardButton(f"🎲 Bet 10", callback_data=f"duelbet_{duel_id}_10")],
            [InlineKeyboardButton(f"💰 Bet 50", callback_data=f"duelbet_{duel_id}_50")],
            [InlineKeyboardButton(f"🔥 Bet 100", callback_data=f"duelbet_{duel_id}_100")],
            [InlineKeyboardButton(f"💎 Bet 200", callback_data=f"duelbet_{duel_id}_200")],
            [InlineKeyboardButton("❌ Cancel", callback_data=f"duelcancel_{duel_id}")]
        ]
        await update.message.reply_text(
...
async def duel_bet_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    user_id = query.from_user.id
    ...
    try:
        ...
        if user_id != duel['challenger_id']:
            await query.answer("Only the challenger can set the bet!", show_alert=True)
            return
            
        cur.execute("SELECT * FROM players WHERE user_id = %s", (user_id, ))
        challenger = cur.fetchone()
        if challenger.get('coins', 0) < bet_amount:
            await query.answer(f"Not enough coins! Need {bet_amount}.", show_alert=True)
            return
            
        cur.execute("UPDATE duels SET bet_amount = %s WHERE id = %s", (bet_amount, duel_id))
        conn.commit()
        
        keyboard = [
            [InlineKeyboardButton("✅ Accept Duel", callback_data=f"duelaccept_{duel_id}")],
            [InlineKeyboardButton("❌ Decline", callback_data=f"dueldecline_{duel_id}")]
        ]
        await query.edit_message_text(
...
async def duel_cancel_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    ...
    cur = conn.cursor()
    try:
        cur.execute("UPDATE duels SET status = 'cancelled' WHERE id = %s", (duel_id, ))
        conn.commit()
...
async def duel_accept_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        cur.execute("SELECT * FROM players WHERE user_id = %s", (duel['defender_id'], ))
        defender = cur.fetchone()
        if defender.get('coins', 0) < duel['bet_amount']:
            await query.answer(f"Not enough coins! Need {duel['bet_amount']}.", show_alert=True)
            return
...
async def duel_attack_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if random.random() < 0.15:
            enemy_damage = random.randint(defender_fighter['current_power'] // 5, defender_fighter['current_power'] // 3)
            new_attacker_power = max(0, attacker_fighter['current_power'] - enemy_damage)
            cur.execute("UPDATE player_characters SET current_power = %s WHERE id = %s", (new_attacker_power, attacker_fighter['id']))
            conn.commit()
        ...
        your_damage = random.randint(attacker_fighter['current_power'] // 4, attacker_fighter['current_power'] // 2)
        enemy_damage = random.randint(defender_fighter['current_power'] // 6, defender_fighter['current_power'] // 4)
        
        new_defender_power = max(0, defender_fighter['current_power'] - your_damage)
        new_attacker_power = max(0, attacker_fighter['current_power'] - enemy_damage)
        
        cur.execute("UPDATE player_characters SET current_power = %s WHERE id = %s", (new_defender_power, defender_fighter['id']))
        cur.execute("UPDATE player_characters SET current_power = %s WHERE id = %s", (new_attacker_power, attacker_fighter['id']))
        conn.commit()
        ...
        if new_defender_power <= 0:
            ...
            if next_defender:
                if attacker_id == duel_session['challenger_id']:
                    cur.execute("UPDATE duel_sessions SET defender_active_slot = %s WHERE id = %s", (next_defender['slot'], duel_session_id))
                else:
                    cur.execute("UPDATE duel_sessions SET challenger_active_slot = %s WHERE id = %s", (next_defender['slot'], duel_session_id))
                conn.commit()
                await query.edit_message_text(
                    f"💥 {defender_fighter['name']} fainted!\n\n{next_defender['name']} enters the battle!\n\n🔵 {attacker_fighter['name']} - {attacker_fighter['current_power']} HP\n🔴 {next_defender['name']} - {next_defender['current_power']} HP",
                    parse_mode='Markdown'
                )
                next_turn = defender_id
                cur.execute("UPDATE duel_sessions SET current_turn = %s WHERE id = %s", (next_turn, duel_session_id))
            ...
            if next_attacker:
                if attacker_id == duel_session['challenger_id']:
                    cur.execute("UPDATE duel_sessions SET challenger_active_slot = %s WHERE id = %s", (next_attacker['slot'], duel_session_id))
                else:
                    cur.execute("UPDATE duel_sessions SET defender_active_slot = %s WHERE id = %s", (next_attacker['slot'], duel_session_id))
                conn.commit()
                await query.edit_message_text(
                    f"💥 {attacker_fighter['name']} fainted!\n\n{next_attacker['name']} enters the battle!\n\n🔵 {next_attacker['name']} - {next_attacker['current_power']} HP\n🔴 {defender_fighter['name']} - {defender_fighter['current_power']} HP",
                    parse_mode='Markdown'
                )
                next_turn = defender_id
                cur.execute("UPDATE duel_sessions SET current_turn = %s WHERE id = %s", (next_turn, duel_session_id))
...
async def send_duel_battle_message(bot, chat_id, duel_session_id, edit_message_id=None):
    ...
    try:
        ...
        if current_turn == challenger_id:
            ...
            turn_name = challenger_player['username']
        else:
            attacker_fighter = defender_fighter
            turn_name = defender_player['username']
            
        attacks = get_character_attacks(attacker_fighter['name'])
        keyboard = [
            [InlineKeyboardButton(f"⚔️ {attacks[0]}", callback_data=f"duel_attack_{duel_session_id}_0")],
            [InlineKeyboardButton(f"⚔️ {attacks[1]}", callback_data=f"duel_attack_{duel_session_id}_1")],
            [InlineKeyboardButton(f"⚔️ {attacks[2]}", callback_data=f"duel_attack_{duel_session_id}_2")],
            [InlineKeyboardButton(f"⚔️ {attacks[3]}", callback_data=f"duel_attack_{duel_session_id}_3")],
            [InlineKeyboardButton("🔄 Swap Character", callback_data=f"duel_swap_{duel_session_id}")],
            [InlineKeyboardButton("🏃 Run Away", callback_data=f"duel_run_{duel_session_id}")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        caption = f"⚔️ **DUEL BATTLE!** ⚔️\n\n🔵 {challenger_player['username']}: {challenger_fighter['name']} - {challenger_fighter['current_power']} HP\n🔴 {defender_player['username']}: {defender_fighter['name']} - {defender_fighter['current_power']} HP\n\n{turn_name}'s turn! Choose attack."
...
async def duel_swap_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if duel_session.get('last_action_time'):
            elapsed = (datetime.now() - duel_session['last_action_time']).total_seconds()
            if elapsed < 5:
                await query.answer(f"Swap cooldown! Wait {int(5 - elapsed)}s", show_alert=True)
                return
                
        keyboard = [[InlineKeyboardButton(f"{char['name']} ({char['current_power']} HP)", callback_data=f"duel_swapto_{duel_session_id}_{char['slot']}")] for char in available]
        keyboard.append([InlineKeyboardButton("🔙 Back", callback_data=f"duel_back_{duel_session_id}")])
        await query.edit_message_text("🔄 Select a character to swap:", reply_markup=InlineKeyboardMarkup(keyboard))
    finally:
        cur.close()
        conn.close()
...
async def duel_swapto_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if user_id == duel_session['challenger_id']:
            cur.execute("UPDATE duel_sessions SET challenger_active_slot = %s WHERE id = %s", (slot, duel_session_id))
        else:
            cur.execute("UPDATE duel_sessions SET defender_active_slot = %s WHERE id = %s", (slot, duel_session_id))
        conn.commit()
        await query.edit_message_text("🔄 **SWAPPED!**\n\nNew fighter enters battle!", parse_mode='Markdown')
        await send_duel_battle_message(context.bot, query.message.chat_id, duel_session_id, edit_message_id=query.message.id)
    finally:
        cur.close()
        conn.close()
...
async def duel_run_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # ⚠️ YAHAN PARENTHESIS FIX KIYA GAYA HAI ⚠️
        if user_id != duel_session['current_turn']:
            await query.answer("It's not your turn!", show_alert=True)
            return
...
async def admin_give_mafuba(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cur = conn.cursor()
    try:
        cur.execute(f"UPDATE players SET mafuba_{mafuba_type} = mafuba_{mafuba_type} + %s WHERE user_id = %s", (amount, target_id))
        conn.commit()
...
async def admin_add_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cur = conn.cursor()
    try:
        cur.execute("INSERT INTO admins (user_id, is_owner) VALUES (%s, FALSE) ON CONFLICT (user_id) DO NOTHING", (target_id, ))
        conn.commit()
...
async def admin_remove_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ⚠️ YAHAN BHI FINALLY BLOCK KA INDENT FIX KIYA GAYA HAI ⚠️
    finally:
        cur.close()
        conn.close()
